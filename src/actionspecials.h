...
DEFINE_SPECIAL(Floor_LowerToHighestEE, 256, -1, -1, 3)
DEFINE_SPECIAL(Floor_RaiseToLowest, 257, -1, -1, 3)
DEFINE_SPECIAL(Floor_LowerToLowestCeiling, 258, -1, -1, 3)
DEFINE_SPECIAL(Floor_RaiseToCeiling, 259, -1, -1, 5)
DEFINE_SPECIAL(Floor_ToCeilingInstant, 260, -1, -1, 4)
DEFINE_SPECIAL(Floor_LowerByTexture, 261, -1, -1, 3)
DEFINE_SPECIAL(Ceiling_RaiseToHighest, 262, -1, -1, 3)
DEFINE_SPECIAL(Ceiling_ToHighestInstant, 263, -1, -1, 3)
DEFINE_SPECIAL(Ceiling_LowerToNearest, 264, -1, -1, 4)
DEFINE_SPECIAL(Ceiling_RaiseToLowest, 265, -1, -1, 3)
DEFINE_SPECIAL(Ceiling_RaiseToHighestFloor, 266, -1, -1, 3)
DEFINE_SPECIAL(Ceiling_ToFloorInstant, 267, -1, -1, 4)
DEFINE_SPECIAL(Ceiling_RaiseByTexture, 268, -1, -1, 3)
DEFINE_SPECIAL(Ceiling_LowerByTexture, 269, -1, -1, 4)
DEFINE_SPECIAL(Stairs_BuildDownDoom, 270, -1, -1, 5)
DEFINE_SPECIAL(Stairs_BuildUpDoomSync, 271, -1, -1, 4)
DEFINE_SPECIAL(Stairs_BuildDownDoomSync, 272, -1, -1, 4)
DEFINE_SPECIAL(Stairs_BuildUpDoomCrush, 273, -1, -1, 5)
DEFINE_SPECIAL(Door_AnimatedClose, 274, -1, -1, 4)
DEFINE_SPECIAL(Floor_Stop, 275, 1, 1, 1)
DEFINE_SPECIAL(Ceiling_Stop, 276, 1, 1, 1)
DEFINE_SPECIAL(Sector_SetFloorGlow, 277, -1, -1, 5)
DEFINE_SPECIAL(Sector_SetCeilingGlow, 278, -1, -1, 5)
DEFINE_SPECIAL(Floor_MoveToValueAndCrush, 279, -1, -1, 5)
DEFINE_SPECIAL(Ceiling_MoveToValueAndCrush, 280, -1, -1, 5)
DEFINE_SPECIAL(Line_SetAutomapFlags, 281, -1, -1, 3)
DEFINE_SPECIAL(Line_SetAutomapStyle, 282, -1, -1, 2)
DEFINE_SPECIAL(Polyobj_StopSound, 283, -1, -1, 1)
DEFINE_SPECIAL(Generic_CrusherDist, 284, -1, -1, 5)
